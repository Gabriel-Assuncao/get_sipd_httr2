...
#' @examples
#' \donttest{
#' pnadc.svy <- get_pnadc_httr2(year=2017, quarter=4, selected=FALSE, vars=c("VD4001","VD4002"),
...
#' pnadc.svy2 <- get_pnadc_httr2(year=2017, interview=5, selected=FALSE, vars=c("V4112","V4121B"),
#'                         defyear=2017, defperiod=4, labels=TRUE, deflator=TRUE, design=TRUE,
#'                         reload=TRUE, savedir=tempdir())
...
#' pnadc.svy3 <- get_pnadc_httr2(year=2017, topic=4, selected=FALSE, vars=c("S07006","S07007"),
#'                         defyear=2017, defperiod=4, labels=TRUE, deflator=TRUE, design=TRUE,
#'                         reload=TRUE, savedir=tempdir())
...
get_pnadc_httr2 <- function(year, quarter = NULL, interview = NULL, topic = NULL, selected = FALSE, vars = NULL, defyear = NULL, defperiod = NULL, 
                       labels = TRUE, deflator = TRUE, design = TRUE, reload = TRUE, savedir = tempdir())
{
    ...
    if (deflator == TRUE) {
      if (exists("pnadc_deflator", where="package:PNADcIBGE", mode="function")) {
        ...
        if (reload == FALSE & file.exists(paste0(savedir, "/Deflatores.zip"))) {
          ...
          httr2::req_perform(req=httr2::request(base_url=paste0(ftpdir, "Documentacao/", defzip)) |> httr2::req_progress(), path=paste0(savedir, "/Deflatores.zip"), verbosity=1)
          if (reload == FALSE) {
  ...
  if (!is.null(interview)) {
    ...
    utils::unzip(zipfile=paste0(savedir, "/", dataname), exdir=savedir)
    docfiles <- unlist(strsplit(unlist(strsplit(unlist(strsplit(gsub("\r\n", "\n", httr2::req_perform(req=httr2::request(base_url=paste0(ftpdir, "Visita_", interview, "/Documentacao/"))) |> httr2::resp_body_string()), "\n")), "<a href=[[:punct:]]")), ".txt"))
    if (year < 2015) {
    ...
    if (reload == FALSE & file.exists(paste0(savedir, "/", inputpre))) {
      ...
      httr2::req_perform(req=httr2::request(base_url=paste0(ftpdir, "Visita_", interview, "/Documentacao/", inputpre)) |> httr2::req_progress(), path=paste0(savedir, "/", inputpre), verbosity=1)
      if (reload == FALSE) {
    ...
    if (labels == TRUE) {
      if (exists("pnadc_labeller", where="package:PNADcIBGE", mode="function")) {
        ...
        if (reload == FALSE & file.exists(paste0(savedir, "/", dicpre))) {
          ...
          httr2::req_perform(req=httr2::request(base_url=paste0(ftpdir, "Visita_", interview, "/Documentacao/", dicpre)) |> httr2::req_progress(), path=paste0(savedir, "/", dicpre), verbosity=1)
          if (reload == FALSE) {
    ...
    if (deflator == TRUE) {
      if (exists("pnadc_deflator", where="package:PNADcIBGE", mode="function")) {
        ...
        arcfiles <- unlist(strsplit(unlist(strsplit(unlist(strsplit(gsub("\r\n", "\n", httr2::req_perform(req=httr2::request(base_url=paste0(ftpdir, "Documentacao_Geral/"))) |> httr2::resp_body_string()), "\n")), "<a href=[[:punct:]]")), ".xls"))
        if (is.null(defyear)) {
        ...
        if (reload == FALSE & file.exists(paste0(savedir, "/", defpre))) {
          ...
          httr2::req_perform(req=httr2::request(base_url=paste0(ftpdir, "Documentacao_Geral/", defpre)) |> httr2::req_progress(), path=paste0(savedir, "/", defpre), verbosity=1)
          if (reload == FALSE) {
            message("The definition of FALSE for the reload argument will be ignored, since the file of deflator was not downloaded yet.\n")
          }
        }
  ...
  if (!is.null(topic)) {
    ...
    utils::unzip(zipfile=paste0(savedir, "/", dataname), exdir=savedir)
    docfiles <- unlist(strsplit(unlist(strsplit(unlist(strsplit(gsub("\r\n", "\n", httr2::req_perform(req=httr2::request(base_url=paste0(ftpdir, "Trimestre_", topic, "/Documentacao/"))) |> httr2::resp_body_string()), "\n")), "<a href=[[:punct:]]")), ".txt"))
    inputpre <- paste0(docfiles[which(startsWith(docfiles, paste0("input_PNADC_trimestre", topic)))], ".txt")
    if (reload == FALSE & file.exists(paste0(savedir, "/", inputpre))) {
      message("The reload argument was defined as FALSE and the file of input was already downloaded, so the download process will not execute again.\n")
    }
    else {
      httr2::req_perform(req=httr2::request(base_url=paste0(ftpdir, "Trimestre_", topic, "/Documentacao/", inputpre)) |> httr2::req_progress(), path=paste0(savedir, "/", inputpre), verbosity=1)
      if (reload == FALSE) {
        message("The definition of FALSE for the reload argument will be ignored, since the file of input was not downloaded yet.\n")
      }
    }
    ...
    if (labels == TRUE) {
      if (exists("pnadc_labeller", where="package:PNADcIBGE", mode="function")) {
        ...
        if (reload == FALSE & file.exists(paste0(savedir, "/", dicpre))) {
          ...
          httr2::req_perform(req=httr2::request(base_url=paste0(ftpdir, "Trimestre_", topic, "/Documentacao/", dicpre)) |> httr2::req_progress(), path=paste0(savedir, "/", dicpre), verbosity=1)
          if (reload == FALSE) {
            message("The definition of FALSE for the reload argument will be ignored, since the file of dictionary was not downloaded yet.\n")
          }
        }
    ...
    if (deflator == TRUE) {
      if (exists("pnadc_deflator", where="package:PNADcIBGE", mode="function")) {
        ...
        perfiles <- unlist(strsplit(unlist(strsplit(unlist(strsplit(gsub("\r\n", "\n", httr2::req_perform(req=httr2::request(base_url=paste0(ftpdir, "Trimestre_", defperiod, "/Documentacao/"))) |> httr2::resp_body_string()), "\n")), "<a href=[[:punct:]]")), ".xls"))
        ...
        if (reload == FALSE & file.exists(paste0(savedir, "/", defpre))) {
          ...
          httr2::req_perform(req=httr2::request(base_url=paste0(ftpdir, "Trimestre_", defperiod, "/Documentacao/", defpre)) |> httr2::req_progress(), path=paste0(savedir, "/", defpre), verbosity=1)
          if (reload == FALSE) {
            message("The definition of FALSE for the reload argument will be ignored, since the file of deflator was not downloaded yet.\n")
          }
        }
