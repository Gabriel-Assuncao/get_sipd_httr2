...
#' @examples
#' \donttest{
#' pns.svy <- get_pns_httr2(year=2019, selected=FALSE, anthropometry=FALSE, vars=c("J007","J009"),
...
#' pns.svy2 <- get_pns_httr2(year=2019, selected=TRUE, anthropometry=FALSE, vars=c("N001","N00101"),
#'                        labels=TRUE, deflator=TRUE, design=TRUE,
#'                        reload=TRUE, savedir=tempdir())
#' # Calculating proportion of people's self-rated health
#' if (!is.null(pns.svy2)) survey::svymean(x=~N001, design=pns.svy2, na.rm=TRUE)
#' pns.svy3 <- get_pns_httr2(year=2019, selected=FALSE, anthropometry=TRUE, vars=c("W00101","W00201"),
#'                        labels=TRUE, deflator=TRUE, design=TRUE,
#'                        reload=TRUE, savedir=tempdir())
...
get_pns_httr2 <- function(year, selected = FALSE, anthropometry = FALSE, vars = NULL,
